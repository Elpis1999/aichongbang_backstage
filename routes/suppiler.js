...
router.post('/', async function (req, res) {
  let { supp_number, supp_name, supp_add, supp_phone, supp_web, supp_bus_pic, supp_note} = req.body;
  client.post('/suppiler', { supp_number, supp_name, supp_add, supp_phone, supp_web, supp_bus_pic, supp_note  })
  res.send({ status: 1 });
});
//查找
...
router.put("/:id", async function (req, res) {
  ...
  await client.put("/suppiler/" + id, {
    supp_number, supp_name, supp_add, supp_phone, supp_web, supp_bus_pic, supp_note  
  });
  res.send({ status: 1 });
